...
public class FXMLController {
    ...
    void doNuova(ActionEvent event) {
    	//comunico che inizia una partita
    ...
    void doTentativo(ActionEvent event) {
    	...
    	if(risultato==0) {
    		txtRisultato.appendText("Hai vinto! Hai vinto con "+ model.getTentativi() +" tentativi.\n");
    		return;
    	}
    	if(risultato==-1) {
    	...
    	txtRimasti.setText(Integer.toString(this.model.getTMAX()-this.model.getTentativi()));
